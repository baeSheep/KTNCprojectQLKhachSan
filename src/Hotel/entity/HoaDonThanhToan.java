...
public class HoaDonThanhToan {
   ...
   @Override
    ...
    public HoaDonThanhToan(String hD001) {
    }
    ...
    public HoaDonThanhToan(String MaHD, int MaDP, String MaNV, String MaKH, String NgayThue, String NgayTraD, int par1, String ngayLap) {
        this.MaHD = MaHD;
        this.MaDP = MaDP;
        this.MaNV = MaNV;
        this.MaKH = MaKH;
