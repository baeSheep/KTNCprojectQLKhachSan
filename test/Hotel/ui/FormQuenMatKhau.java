...
public class FormQuenMatKhau extends javax.swing.JFrame {
    ...
    private Object formXacNhanMatKhau;
    private FormQuenMatKhau form;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Khôi Phục Tài Khoản", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
        ...
        txtEmail.setText("huyenpttps35245@fpt.edu.vn");
    ...
    // Test khôi phục mật khẩu khi nhập đúng mã nhân viên và email
    @Test
    public void testKhoiPhucMatKhau() {
        form.txtMaNV.setText("NV01");
        form.txtEmail.setText("huyenpttps35245@fpt.edu.vn");
        form.khoiphuc();
        // Kiểm tra xem form xác nhận mật khẩu có được hiển thị hay không
        assertNotNull(form.formXacNhanMatKhau);
    }

    // Test thông báo khi không tìm thấy mã nhân viên
    @Test
    public void testKhongTimThayMaNV() {
        form.txtMaNV.setText("NV99");
        form.txtEmail.setText("huyenpttps35245@fpt.edu.vn");
        form.khoiphuc();
        // Kiểm tra xem thông báo có hiển thị đúng hay không
        assertEquals("Không tìm thấy mã nhân viên NV99", form.getOptionPaneMessage());
    }

    // Test gửi email khôi phục mật khẩu
    @Test
    public void testGuiEmailKhoiPhucMatKhau() {
        form.txtMaNV.setText("NV01");
        form.txtEmail.setText("huyenpttps35245@fpt.edu.vn");
        form.khoiphuc();
        // Kiểm tra xem có gọi hàm Transport.send(msg) khi gửi email hay không
        assertTrue(form.isTransportSendCalled());
    }

    // Test xác nhận mã xác nhận qua email
    @Test
    public void testXacNhanMaXacNhanQuaEmail() {
        form.txtMaNV.setText("NV01");
        form.txtEmail.setText("huyenpttps35245@fpt.edu.vn");
        form.khoiphuc();
        // Simulate user input
        form.setInputCode("ABC123"); // Mã xác nhận đúng là ABC123
        form.clickConfirmButton();
        // Kiểm tra xem form xác nhận mật khẩu có được đóng hay không
        assertFalse(form.isFormXacNhanMatKhauVisible());
    }

    // Test thông báo khi nhập sai mã xác nhận qua email
    @Test
    public void testThongBaoNhapSaiMaXacNhan() {
        form.txtMaNV.setText("NV01");
        form.txtEmail.setText("huyenpttps35245@fpt.edu.vn");
        form.khoiphuc();
        // Simulate user input
        form.setInputCode("XYZ789"); // Mã xác nhận sai là XYZ789
        form.clickConfirmButton();
        // Kiểm tra xem thông báo có hiển thị đúng hay không
        assertEquals("Mã xác nhận không đúng! Vui lòng nhập lại.", form.getOptionPaneMessage());
    }

    // Test đóng form
    @Test
    public void testDongForm() {
        form.clickCloseButton();
        // Kiểm tra xem form đã đóng hay chưa
    ...
    private void setInputCode(String abC123) {
    ...
    private boolean isFormXacNhanMatKhauVisible() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private boolean isTransportSendCalled() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    void khoiphuc(String nV01, String huyenpttps35245fpteduvn) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
