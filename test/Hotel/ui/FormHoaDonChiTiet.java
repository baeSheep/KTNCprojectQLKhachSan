...
public final class FormHoaDonChiTiet extends javax.swing.JFrame {
    ...
    public void initData() {
        ...
        // truy vấn lấy mã đặt phòng thông qua mã hóa đơn
    ...
    public void testInitDataWithValidData() {
        try {
            ...
            assertEquals("HD093", form.txtMaHD.getText());
            assertEquals("2024-03-12 00:00:00.000", form.txtNgayThue.getText());
    ...
    public void testInitDataWithInvalidData() {
        try {
            String maHD = "HD093"; // Using invalid ID to fetch data
